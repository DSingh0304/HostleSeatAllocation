...
- Replace development SMTP credentials before production use
- Prefer managed PostgreSQL/Redis in production environments
- Enforce HTTPS at ingress/load balancer level

## Suggested GitHub Publishing Strategy

For a polished public history, publish in stages:
1. Repo hygiene and docs
2. Backend foundations
3. Business modules and tests
4. Frontend shell and dashboards
5. DevOps and CI

## Future Improvements

- Add OpenAPI/Swagger documentation
- Add end-to-end tests for critical booking flows
- Add observability stack (structured metrics + tracing)
- Improve role-specific dashboards and analytics depth

## License

Add a license file based on your preferred usage model (MIT/Apache-2.0/proprietary).
